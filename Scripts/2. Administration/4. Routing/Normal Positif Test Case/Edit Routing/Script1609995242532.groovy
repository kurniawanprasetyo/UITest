...
WebUI.selectOptionByValue(findTestObject('Object Repository/Routing/select_3510'), '10', true)
...
WebUI.selectOptionByValue(findTestObject('Routing/Select Mitra'), '111111', true)
