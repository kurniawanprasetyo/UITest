...
WebUI.selectOptionByValue(findTestObject('Routing/Select Institution'), ca_id, true)

WebUI.selectOptionByValue(findTestObject('Routing/Select Feature'), feature, true)

WebUI.selectOptionByValue(findTestObject('Routing/Input Destination'), dest_id, true)
...
WebUI.selectOptionByValue(findTestObject('Routing/Select Mitra'), mitra, true)
