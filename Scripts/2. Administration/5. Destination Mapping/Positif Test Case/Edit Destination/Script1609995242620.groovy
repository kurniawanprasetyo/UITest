...
WebUI.setText(findTestObject('Object Repository/Destination/input_Destination Name'), 'All Banks Cyprus')

WebUI.selectOptionByValue(findTestObject('Object Repository/Destination/select Country Code'), 'CYP', true)
...
WebUI.setText(findTestObject('Object Repository/Destination/input Transferto Payer ID'), '2003')
