...
WebUI.click(findTestObject('Object Repository/Destination/button Edit'))

dest_id = WebUI.getText(findTestObject('Object Repository/Destination/Get Destination ID'))

WebUI.click(findTestObject('Object Repository/Destination/button Cancel'))

String destination_id = dest_id.split(/[()]/)[1];

WebUI.click(findTestObject('Object Repository/Destination/button Add Dest'))

WebUI.setText(findTestObject('Object Repository/Destination/input Destination ID'), destination_id)
...
WebUI.setText(findTestObject('Object Repository/Destination/input Transferto Payer ID'), GlobalVariable.transferto_payer)

WebUI.click(findTestObject('Object Repository/Destination/button_Save'))

WebUI.verifyElementPresent(findTestObject('Object Repository/Destination/Notif Error Dest ID Already Use'), 5)