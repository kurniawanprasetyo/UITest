...
WebUI.selectOptionByValue(findTestObject('Object Repository/Destination/select Country Code'), 'JPN', true)

WebUI.selectOptionByLabel(findTestObject('Object Repository/Destination/select Feature'), '-- Choose Feature --', true)
