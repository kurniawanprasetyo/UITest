...
WebUI.scrollToElement(findTestObject('Object Repository/Rate Artajasa/submenu Rate Artajasa'), 3)

WebUI.click(findTestObject('Object Repository/Rate Artajasa/submenu Rate Artajasa'))
...
while (!eDestCurr.equals(sDestCurr)){
	...
	table: for (int i = 0; i < Rows.size(); i++) {
		...
		if (Cols.get(0).getText().equalsIgnoreCase(eDestCurr)) {
			...
			Cols.get(6).findElement(By.xpath('//*[@id="kt_content"]/div[2]/div/div/div[2]/div[1]/table/tbody/tr['+j+']/td[7]/button')).click()
...
WebUI.sendKeys(findTestObject('Object Repository/Rate Artajasa/input Margin Updated'), Keys.chord(Keys.CONTROL, 'a'))

WebUI.sendKeys(findTestObject('Object Repository/Rate Artajasa/input Margin Updated'), Keys.chord(Keys.BACK_SPACE))

WebUI.setText(findTestObject('Object Repository/Rate Artajasa/input Margin Updated'), GlobalVariable.margin_updated)
