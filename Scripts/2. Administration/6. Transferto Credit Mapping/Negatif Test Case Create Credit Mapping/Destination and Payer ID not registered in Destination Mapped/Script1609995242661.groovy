...
WebUI.setText(findTestObject('Object Repository/TT Credit Mapping/input_Payer ID'), '1989282929')

WebUI.click(findTestObject('Object Repository/TT Credit Mapping/button_Save'))

WebUI.verifyElementPresent(findTestObject('Object Repository/TT Credit Mapping/Notif error Destination nof Found'),10)