...
while (!eDestination.equals(sDestination)){
	...
	table: for (int i = 0; i < Rows.size(); i++) {
		...
		if (Cols.get(0).getText().equalsIgnoreCase(eDestination)) {
			...
			Cols.get(4).findElement(By.xpath('//*[@id="kt_content"]/div[2]/div/div/div[2]/div[1]/table/tbody/tr['+j+']/td[5]/button[2]')).click()
...
WebUI.click(findTestObject('Object Repository/TT Credit Mapping/button_Konfrimasi Delete'))

WebUI.verifyElementPresent(findTestObject('Object Repository/TT Credit Mapping/Notif success delete'),10)