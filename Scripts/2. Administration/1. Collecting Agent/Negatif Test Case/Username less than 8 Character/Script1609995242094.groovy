...
// Masukkan username kurang dari 8 karakter

WebUI.setText(findTestObject('Create CA/Username PIC'), RandomStringUtils.randomAlphanumeric(6))
...
WebUI.verifyElementPresent(findTestObject('Create CA/Error Must be 8 character'), 10)