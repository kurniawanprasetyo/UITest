...
// Masukkan TDP kurang dari 13 karakter

WebUI.setText(findTestObject('Create CA/No TDP'), RandomStringUtils.randomNumeric(10))
...
WebUI.verifyElementPresent(findTestObject('Create CA/Error Must be 13 character'), 10)