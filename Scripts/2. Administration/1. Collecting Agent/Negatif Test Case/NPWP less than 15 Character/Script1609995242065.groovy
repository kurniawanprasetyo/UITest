...
// Masukkan NPWP kurang dari 15 karakter (random)

WebUI.setText(findTestObject('Create CA/No NPWP'), RandomStringUtils.randomNumeric(10))
...
WebUI.verifyElementPresent(findTestObject('Create CA/Error Must be 15 character'), 10)