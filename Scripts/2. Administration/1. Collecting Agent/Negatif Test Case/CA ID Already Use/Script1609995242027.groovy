...
// Melakukan pencarian CA ID yang sudah terdaftar
...
inst_id = Cols.get(0).getText()

// Masuk ke form create CA

WebUI.click(findTestObject('Create CA/Add CA'))

// Memasukkan CA ID yang sudah terdaftar sebelumnya

WebUI.setText(findTestObject('Create CA/Institution ID'), inst_id)
...
WebUI.setText(findTestObject('Create CA/Username PIC'), RandomStringUtils.randomNumeric(8))
