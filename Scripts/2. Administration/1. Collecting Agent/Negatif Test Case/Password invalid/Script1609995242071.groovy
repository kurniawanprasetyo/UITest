...
// Masukkan password yang kurang sesuai (random)

WebUI.setText(findTestObject('Create CA/Password PIC'), RandomStringUtils.randomAlphanumeric(6))
...
WebUI.verifyElementPresent(findTestObject('Create CA/Error Password invalid'), 10)