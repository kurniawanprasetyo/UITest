...
WebUI.sendKeys(findTestObject('Fee/Add Fee/Klik start periode'), Keys.chord(Keys.CONTROL, 'a'))

WebUI.sendKeys(findTestObject('Fee/Add Fee/Klik start periode'), Keys.chord(Keys.BACK_SPACE))
