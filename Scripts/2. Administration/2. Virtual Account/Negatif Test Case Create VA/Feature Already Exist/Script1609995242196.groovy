...
WebUI.selectOptionByValue(findTestObject('Object Repository/Virtual Account/select_Choose Institutions'),'241120', true)

WebUI.selectOptionByValue(findTestObject('Object Repository/Virtual Account/select_Choose Status'), 'ACTIVE', true)

WebUI.setText(findTestObject('Object Repository/Virtual Account/input_EnterVirtual Account ID_va_id'), '24112000936000203')
