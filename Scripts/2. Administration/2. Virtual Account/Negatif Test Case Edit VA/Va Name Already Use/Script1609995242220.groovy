...
List<WebElement> Cols2 = Rows2.get(2).findElements(By.tagName('td'))

existVAname = Cols2.get(1).getText()
...
WebUI.setText(findTestObject('Object Repository/Virtual Account/input_Virtual Account Name'), existVAname)

WebUI.selectOptionByValue(findTestObject('Object Repository/Virtual Account/select_Choose Status'), 'INACTIVE', true)

WebUI.click(findTestObject('Object Repository/Virtual Account/button_Save'))

WebUI.verifyElementPresent(findTestObject('Object Repository/Virtual Account/Notif VA Name already use'), 10)