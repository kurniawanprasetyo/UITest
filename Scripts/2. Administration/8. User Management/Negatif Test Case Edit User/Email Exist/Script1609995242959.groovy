...
println(Cols2.get(3).getText())

existEmail = Cols2.get(3).getText()
...
WebUI.setText(findTestObject('Object Repository/User Management/Email'), existEmail)

WebUI.click(findTestObject('Object Repository/User Management/button_Save(Edit)'))

WebUI.verifyElementPresent(findTestObject('Object Repository/User Management/Notif Email Exist'), 10)