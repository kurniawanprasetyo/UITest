...
WebElement table2 = driver2.findElement(By.xpath("//*[@id='kt_content']/div[2]/div/div/div[2]/div[1]/table/tbody"))

List<WebElement> Rows2 = table2.findElements(By.tagName('tr'))

List<WebElement> Cols2 = Rows2.get(0).findElements(By.tagName('td'))

println(Cols2.get(2).getText())

existUsername = Cols2.get(2).getText()
...
WebUI.sendKeys(findTestObject('Object iRepository/User Management/Edit_Phone'), Keys.chord(Keys.BACK_SPACE))
...
WebUI.setText(findTestObject('Object Repository/User Management/Edit_Username'), existUsername)
...
WebUI.setText(findTestObject('Object Repository/User Management/Email'), 'mbekurprasetyo@gmail.com')
