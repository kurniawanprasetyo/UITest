...
table: for (int i = 0; i < Rows.size(); i++) {
	...
	for (int j = 0; j < Cols.size(); j++) {
		...
		if (Cols.get(j).getText().equalsIgnoreCase(ExpectedUsername)) {
			...
			Cols.get(7).findElement(By.xpath('//*[@id="kt_content"]/div[2]/div/div/div[2]/div[1]/table/tbody/tr['+k+']/td[8]/button[2]')).click()
...
WebUI.selectOptionByValue(findTestObject('Object Repository/User Management/Choose Status'), 'NOT ACTIVE', true)
