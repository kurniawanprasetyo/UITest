...
WebUI.setText(findTestObject('User Management/First Name'), GlobalVariable.user_first_name2)

WebUI.setText(findTestObject('User Management/Last Name'), GlobalVariable.user_last_name2)

WebUI.setText(findTestObject('User Management/Phone Number'), GlobalVariable.user_phone_number)

WebUI.setText(findTestObject('User Management/Username'), GlobalVariable.user_username2)

WebUI.setText(findTestObject('User Management/Email'), GlobalVariable.user_email2)
...
WebUI.click(findTestObject('User Management/div_Successfull register user  202010091511_0a9b67'))