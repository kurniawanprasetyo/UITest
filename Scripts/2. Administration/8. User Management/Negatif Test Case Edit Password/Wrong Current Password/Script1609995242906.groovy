...
WebUI.setText(findTestObject('Object Repository/User Management/currentPassword'), 'Kurniawan1234567!')

WebUI.setText(findTestObject('Object Repository/User Management/newPassword'), GlobalVariable.newPassword)

WebUI.setText(findTestObject('Object Repository/User Management/confirmNewPassword'), GlobalVariable.newPassword)

WebUI.click(findTestObject('Object Repository/User Management/button_Save(Edit)'))

WebUI.verifyElementPresent(findTestObject('Object Repository/User Management/Notif Password not Valid'), 10)