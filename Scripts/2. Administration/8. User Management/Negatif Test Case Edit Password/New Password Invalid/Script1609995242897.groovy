...
WebUI.setText(findTestObject('Object Repository/User Management/newPassword'), GlobalVariable.pass_invalid)

WebUI.setText(findTestObject('Object Repository/User Management/confirmNewPassword'), GlobalVariable.pass_invalid)

WebUI.click(findTestObject('Object Repository/User Management/button_Save(Edit)'))

WebUI.verifyElementPresent(findTestObject('Object Repository/User Management/Notif password invalid'), 10)