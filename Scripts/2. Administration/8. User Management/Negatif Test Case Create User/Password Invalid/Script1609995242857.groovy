...
WebUI.setText(findTestObject('User Management/PAssword'), GlobalVariable.pass_invalid)

WebUI.setText(findTestObject('User Management/Confirm Password'), GlobalVariable.pass_invalid)

WebUI.click(findTestObject('User Management/button_Save'))

WebUI.verifyElementPresent(findTestObject('Object Repository/User Management/Notif Invalid Password'), 10)